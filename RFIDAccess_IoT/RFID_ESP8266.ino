...
//#define DEBUG   //If you comment this line, the DPRINT & DPRINTLN lines are defined as blank.
  ...
  #define DPRINT(...)    Serial.print(_VA_ARGS_)     //DPRINT is a macro, debug print
  #define DPRINTLN(...)  Serial.println(_VA_ARGS_)   //DPRINTLN is a macro, debug print with new line
#else
